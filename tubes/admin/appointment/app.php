<?php
    ...
    if(isset($_POST["cari"])) {
        $appointment = cariapp($_POST["keyword"]);
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="app.php"  class="active"><span class="las la-notes-medical"></span><span>Appointment</span></a>
                </li>
                <li>
        ...
        <main>
            <div class="row">
                <div class="card col-sm">
                    <div class="card-body">
                        <h3 class="mt-3 mb-5"> <center>Data Permohonan Janji dengan Dokter</center></h3>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="filter">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?id_app=<?php echo$a['id_app'];?>" class="btn btn-outline-warning btn-sm">Edit</a>
                                        <!-- <a href="delete.php?id_app=<?php echo$a['id_app'];?>" class="btn btn-outline-danger btn-sm">Delete</a> -->
                                    </td>
                                </tr>
                                <?php
                                    endforeach;
