        ...
        <main>
            <div class="row">
                <div class="card col-sm">
                    <div class="card-body">
                        <h3 class="mt-3 mb-5"> <center>Data Pasien</center></h3>
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?id_pasien=<?php echo$a['id_pasien'];?>" class="btn btn-outline-warning btn-sm">Edit</a>
                                        <a href="delete.php?id_pasien=<?php echo$a['id_pasien'];?>" class="btn btn-outline-danger btn-sm">Delete</a>
                                    </td>
                                </tr>
                                <?php
                                    };
