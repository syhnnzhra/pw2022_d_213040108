                ...
                <div class="card col-sm">
                    <div class="card-body">
                        ...
                        <form action="ubah.php" method="post">
                            ...
                            ?>
                                <input type="hidden" class="form-control" id="id_pasien" name="id_pasien" value="<?php echo $a['id_pasien'];?>" required>
                            <div class="mb-3 row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Pasien</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama" name="nama_pasien" value="<?php echo $a['nama_pasien'];?>" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1" value="pria" <?php if($a['gender'] == "pria") { echo "checked"; }?>>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Pria
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault2" value="wanita" <?php if($a['gender'] == "wanita") { echo "checked"; }?>>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="alamat" class="form-control" required id="exampleFormControlTextarea1" rows="3"><?php echo $a['alamat'];?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="date" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                                <div class="col-sm-10">
                                    <input type="text" id="date" required name="tgl_lahir"value="<?php echo $a['tgl_lahir'];?>">
                                </div>
                            </div>
                            <div class="submit">
