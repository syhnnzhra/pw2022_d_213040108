        ...
        <main>
            <div class="row">
                <div class="card col-sm">
                    <div class="card-body">
                        <h3 class="mt-3 mb-5"> <center>Edit Data Pasien</center></h3>
                        <form action="" method="post">
                                <input type="hidden" class="form-control" id="id_pasien" name="id_pasien" value="<?php echo $pasien['id_pasien'];?>" required>
                            <div class="mb-3 row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Pasien</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama" name="nama_pasien" value="<?php echo $pasien['nama_pasien'];?>" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1" value="pria" <?php if($pasien['gender'] == "pria") { echo "checked"; }?>>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Pria
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault2" value="wanita" <?php if($pasien['gender'] == "wanita") { echo "checked"; }?>>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="alamat" class="form-control" required id="exampleFormControlTextarea1" rows="3"><?php echo $pasien['alamat'];?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="date" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                                <div class="col-sm-10">
                                    <input type="text" id="date" required name="tgl_lahir"value="<?php echo $pasien['tgl_lahir'];?>">
                                </div>
                            </div>
                            <div class="submit">
