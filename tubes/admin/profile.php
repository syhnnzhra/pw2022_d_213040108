    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="profile.php" class="active"><span class="las la-user"></span><span>Ubah Profile</span></a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="card col-sm">
                    <div class="card-body">
                        <div class="profile text-center">
                            <img src="img/profile.jpg" alt="" width="30%" class="rounded img-thumbnail">
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" id="role" value="user/admin">
                            </div>
                        </div>
